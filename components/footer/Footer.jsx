...
const Footer = () => {
  return (
    <div className="flex flex-col text-sm">
      <div className="flex absolute flex-col lg:flex-row justify-between p-5 w-full bg-[#f3f5f7]  text-[#495b6e] text-sm">
          ...
          <ul className="flex flex-col gap-4">
            <li>
              <Link href="/about">
                <a>
                  About{' '}
                  <span className="font-black tracking-widest">HEICH</span>
                </a>
              </Link>
            </li>
            <li>
      ...
      <div className="">
        &#64; 2022 <span className="uppercase font-bold">karn</span> developers
      </div>
    </div>
  );
};
